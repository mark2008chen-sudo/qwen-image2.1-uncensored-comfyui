...
> 工作流 / 节点补丁 / Q8_0 修复工具 / 踩坑记录，一站式。
> *ComfyUI workflow · GGUF · text-to-image · image editing · 8 GB VRAM · low-VRAM · quantization fix*
...
[![Model](https://img.shields.io/badge/model-Qwen--Image--2.1%20Uncensored-purple)](#-模型下载)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

<p align="center">
  <img src="assets/sample_t2i_512x512.png" width="440" alt="Sample output generated by Qwen-Image-2.1 Uncensored GGUF on ComfyUI with 8 GB VRAM">
  <br>
  <sub><b>实测直出</b> · 512×512 / 20 步 / cfg 1.0 · RTX 5060 Laptop <b>8 GB</b> · <b>32.3 秒</b> · 未经后期</sub>
</p>
